# Generated by Django 4.0 on 2021-12-19 13:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.CharField(blank=True, choices=[('s', 'small'), ('s', 'medium'), ('s', 'large')], default='s', max_length=60, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Cat',
            fields=[
                ...
                ('owner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='owner', to='catlogs.user')),
            ],
        ),
        migrations.AddField(
            model_name='user',
